...
namespace DepartmentsEmployees
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // DONE PrintDepartmentReport should print a department report to the console, but does it?
            ...
            // DONE Why are they different? They are different because the first is pulling data from the object as instantiated above in Program.cs, in which case it does not yet have an Id. The second is pulling from the database, in which case it has been assigned an Id.
        ...
        public static void PrintEmployeeReport(string title, List<Employee> employees)
        {
            ...
            {
                string employeeDeptString = employee.Department != null ? $". Dept: {employee.Department.DeptName}" : null;
                Console.WriteLine($"{employee.Id}: {employee.FirstName} {employee.LastName}{employeeDeptString}");
            }
